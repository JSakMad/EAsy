...
Be balanced: preserve difficult experiences and disagreement, distinguish teaching quality from grading leniency, and qualify isolated claims as one review. Never invent a grade probability, numbers, guarantees, consensus or missing policies. Never include percentages or the percent sign, even when a review supplies them (including exam weights, grade cutoffs, or attendance credit). Describe supported grading details qualitatively instead, without implying a probability of earning a grade. Omit unsupported study advice; advice must be concrete study actions actually described, never enrollment advice or cheating.
